def sum_matrix(maths, physics, english):
...
overall_scores = list(map(sum_matrix, scores_maths, scores_physics, scores_english))

admitted_students = list(filter(lambda score: score >= minimal_score, overall_scores))
